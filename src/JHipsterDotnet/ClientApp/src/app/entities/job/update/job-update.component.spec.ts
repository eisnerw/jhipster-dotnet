  ...
  describe("Job Management Update Component", () => {
    ...
    describe("ngOnInit", () => {
      it("Should call Task query and add missing value", () => {
        ...
        const tasks: ITask[] = [{ id: 66852 }];
        job.tasks = tasks;

        const taskCollection: ITask[] = [{ id: 50503 }];
        spyOn(taskService, "query").and.returnValue(
          of(new HttpResponse({ body: taskCollection }))
        );
        ...
        spyOn(taskService, "addTaskToCollectionIfMissing").and.returnValue(
          expectedCollection
        );
      ...
      it("Should call Employee query and add missing value", () => {
        ...
        spyOn(employeeService, "query").and.returnValue(
          of(new HttpResponse({ body: employeeCollection }))
        );
        ...
        ).and.returnValue(expectedCollection);
