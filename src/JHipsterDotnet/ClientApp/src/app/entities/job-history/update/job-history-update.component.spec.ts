  ...
  describe("JobHistory Management Update Component", () => {
    ...
    describe("ngOnInit", () => {
      it("Should call job query and add missing value", () => {
        ...
        spyOn(jobService, "query").and.returnValue(
          of(new HttpResponse({ body: jobCollection }))
        );
        const expectedCollection: IJob[] = [job, ...jobCollection];
        spyOn(jobService, "addJobToCollectionIfMissing").and.returnValue(
          expectedCollection
        );
      ...
      it("Should call department query and add missing value", () => {
        ...
        spyOn(departmentService, "query").and.returnValue(
